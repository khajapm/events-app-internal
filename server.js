...
const mockEvents = {
    events: [
        { title: 'an event', id: 1, description: 'something really cool', location: 'San Francisco, CA' },
        { title: 'another event', id: 2, description: 'something even cooler', location: 'Denver, CO' }
    ]
};
